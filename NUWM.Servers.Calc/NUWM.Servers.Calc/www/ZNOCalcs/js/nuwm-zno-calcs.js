(function () {
    ...
    var id = 0,
        ...
        lk = {
            zc_css: "http://" + base + "/ZNOCalcs/css/nuwm-zno.calcs.min.css",
            hlp: "http://" + base + "/api/calc?hlp=",
            anim_css: "http://" + base + "/ZNOCalcs/css/animate.css",
    ...
    function loadjscssfile(t, s) {
        ...
        var timerId = setInterval(function () {
            if (css1 && css2 && !reqsent) {
                reqsent = true;
                jQuery.ajax({
                    url: "http://" + base + "/ZNOCalcs/zno-calcs-misc.html",
    ...
    function LoadCards() {
        ...
        jQuery.ajax({
            type: "json",
            data: "",
            url: "http://" + base + "/api/calc?n=" + all_names + '&v=' + all_values + '&vl=' + vill + (!!pr ? '&pr=' + pr : '') + (!!avm ? '&avm=' + avm : ''),
            success: function (t) {
                SetObjects(t);
